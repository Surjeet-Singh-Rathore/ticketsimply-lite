...
import com.bitla.tscalender.listeners.DialogCompleteListener;
...
public class SlyCalendarDialog extends DialogFragment implements DialogCompleteListener {
    ...
    public SlyCalendarDialog setMinDate(@Nullable Date minDate) {
        slyCalendarData.setMinDate(minDate);
        return this;
    }

    public SlyCalendarDialog setMaxDate(@Nullable Date maxDate) {
        slyCalendarData.setMaxDate(maxDate);
        return this;
    }
