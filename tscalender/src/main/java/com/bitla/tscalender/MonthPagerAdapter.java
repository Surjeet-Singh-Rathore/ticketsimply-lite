...
public class MonthPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(@NonNull final ViewGroup container, final int position) {
        ...
        //((TextView) view.findViewById(R.id.day1)).setText(new SimpleDateFormat("EE", Locale.getDefault()).format(weekDays.getTime()).substring(0, 1).toUpperCase() + new SimpleDateFormat("EE", Locale.getDefault()).format(weekDays.getTime()).substring(1));  // Sun for Sunday
        ((TextView) view.findViewById(R.id.day1)).setText(new SimpleDateFormat("EE", Locale.getDefault()).format(weekDays.getTime()).substring(0, 1).toUpperCase()); //S for Sunday
