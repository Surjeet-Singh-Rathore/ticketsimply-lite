...
class Body {
    ...
    @SerializedName("multihop_service")
    var multihopService: Boolean? = false
    ...
    @SerializedName("branch_legend_details")
    var branchLegendDetails: ArrayList<LegendDetail>? = null
    ...
    @SerializedName("enable_campaign_promotions")
    var enableCampaignPromotions: Boolean? = false

    @SerializedName("is_bima")
    var isBima: Boolean? = null

    @SerializedName("parent_travel_id")
    var parentTravelId: Int = 0
    @SerializedName("is_service_blocked")
    val isServiceBlocked: Boolean? = false

    @SerializedName("coach_id")
    var rAssetId: String = ""

    @SerializedName("is_enable_copy_passenger_checkbox")
