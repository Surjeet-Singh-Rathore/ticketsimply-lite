...
//    var passengerDetails: MutableList<PassengerDetails>? = null
    ...
    var isFrequentTraveller: Boolean? = false

    @SerializedName("is_open_tooltip")
    var isOpenTooltip: Boolean = true

    @SerializedName("multi_hop_seat")
    var multiHopSeat: Boolean = false

    @SerializedName("fare_update_seat_type")
    var fareUpdateSeatType: Boolean = false


    @SerializedName("blocking_number")
