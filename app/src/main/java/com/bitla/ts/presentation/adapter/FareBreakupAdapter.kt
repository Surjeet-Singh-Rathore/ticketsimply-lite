...
import com.bitla.ts.databinding.AdapterFareBreakupBinding
...
class FareBreakupAdapter(
    private val context: Context,
    private var fareBreakUpHashList: MutableList<FareBreakUpHash>,
    private val currency: String,
    private val currencyFormat: String
) :
    RecyclerView.Adapter<FareBreakupAdapter.ViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding =
            AdapterFareBreakupBinding.inflate(LayoutInflater.from(context), parent, false)
    ...
    class ViewHolder(binding: AdapterFareBreakupBinding) :
        RecyclerView.ViewHolder(binding.root) {
        val tvLabel = binding.headTV
        val tvValue = binding.valueTV
    }
}