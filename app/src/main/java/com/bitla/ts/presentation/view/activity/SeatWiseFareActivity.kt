...
class SeatWiseFareActivity : BaseActivity(){

    private var busType: String = ""
    private lateinit var binding: ActivitySeatWiseFareBinding

    @SuppressLint("SetTextI18n")
    override fun initUI() {
        binding = ActivitySeatWiseFareBinding.inflate(layoutInflater)
        ...
        val navController = findNavController(R.id.nav_seatwise_fragment)
...
//        binding.updateRatecardToolbar.textHeaderTitle.text = "$originName - $destinationName"
        binding.updateRatecardToolbar.textHeaderTitle.text = getString(R.string.seat_wise_fare)
