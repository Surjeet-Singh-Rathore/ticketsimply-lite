...
class CoachBpDpBoardingAdapter(
    private val context: Context,
    private var boardingDropping: MutableList<StageDetail>,
    private var onItemClickListener: OnItemClickListener,
    private var selectedItem: BoardingPointDetail,


    ) :
    RecyclerView.Adapter<CoachBpDpBoardingAdapter.ViewHolder>() {
    private var lastSelectedPosition: Int = -1

    companion object {
        var tag: String? = CoachBpDpBoardingAdapter::class.simpleName
    }
