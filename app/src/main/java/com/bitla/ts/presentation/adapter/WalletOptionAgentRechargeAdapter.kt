...
import com.bitla.ts.databinding.ChildAgentRechargeFiltersBinding
...
class WalletOptionAgentRechargeAdapter(
    
    private val context: Context,
    private val onItemClickListener: OnItemClickListener,
    private var walletOptionList: List<WalletPaymentOption>,
    lastSelectedPositionPayment: Int, ) :
    RecyclerView.Adapter<WalletOptionAgentRechargeAdapter.ViewHolder>() {
    
    companion object {
        var TAG: String = WalletOptionAgentRechargeAdapter::class.java.simpleName
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        val binding = ChildAgentRechargeFiltersBinding.inflate(LayoutInflater.from(context), parent, false)
    ...
    inner class ViewHolder(binding: ChildAgentRechargeFiltersBinding) :
