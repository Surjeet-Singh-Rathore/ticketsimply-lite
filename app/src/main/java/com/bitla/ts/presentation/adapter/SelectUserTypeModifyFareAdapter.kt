...
class SelectUserTypeModifyFareAdapter(
    context: Context,
    @LayoutRes private var resource: Int,
    private val textViewResourceId: Int,
    private val objects: MutableList<SpinnerItemsModifyFare>,
    private val selectedUserTypeList: MutableList<SpinnerItemsModifyFare>,
    private val isAllowMultipleQuota: Boolean,
    private val onClickListener: ItemClickListener
) : ArrayAdapter<SpinnerItemsModifyFare>(context, resource, objects) {
    private var mPois: MutableList<SpinnerItemsModifyFare> = objects

    override fun getCount(): Int {
        return objects.size
    }

    override fun getItem(position: Int): SpinnerItemsModifyFare {
    ...
    interface ItemClickListener {
        fun onSelected(position: Int, item: SpinnerItemsModifyFare)
        fun onDeselect(position: Int, item: SpinnerItemsModifyFare)
    }
