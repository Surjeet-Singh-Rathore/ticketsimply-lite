...
//        if (bulkUpdationOfTickets && !serviceDetails?.body.is_service_blocked && !isAllowBpDpFare) {
        ...
        if (privilegeResponseModel?.allowRapidBookingFlow == true) {
            if (!isServiceBlocked) {
                coachOptionsArray.add(
                    CoachOptionsModel(
                        coachOption = getString(R.string.rapid_booking_option),
                        coachOptionIcon = ContextCompat.getDrawable(
                            this, R.drawable.rapid_book_button_new_booking_flow
                        )
                    )
                )
            }
...
//                                Timber.d("orifinidqw", "${dateList}")
                    ...
                    getString(R.string.view_multistation_bookings_option) -> {
                        val intent = Intent(this, ServiceSummaryActivity::class.java)
                        intent.putExtra("TYPE", "Multistation Booking")
                        startActivity(intent)
                        firebaseLogEvent(
                    ...
                    getString(R.string.boarding_point_option) -> {
                        val intent = Intent(this, ServiceSummaryActivity::class.java)
                        intent.putExtra("TYPE", "Boarding Points")
                        startActivity(intent)
                    ...
                    getString(R.string.dropping_point_option) -> {
                        val intent = Intent(this, ServiceSummaryActivity::class.java)
                        intent.putExtra("TYPE", "Dropping Points")
                        startActivity(intent)
                        firebaseLogEvent(
                    ...
                    getString(R.string.booked_by_option) -> {
                        val intent = Intent(this, ServiceSummaryActivity::class.java)
                        intent.putExtra("TYPE", "Booked By")
                        startActivity(intent)
                        firebaseLogEvent(
                    ...
                    getString(R.string.booking_option) -> {
                        val intent = Intent(this, ServiceSummaryActivity::class.java)
                        intent.putExtra("TYPE", "Bookings")
                        startActivity(intent)
                        firebaseLogEvent(
                    ...
                    getString(R.string.collection_option) -> {
                        val intent = Intent(this, ServiceSummaryActivity::class.java)
                        intent.putExtra("TYPE", "Collection")
                        startActivity(intent)
                        firebaseLogEvent(
                    ...
                    getString(R.string.released_ticket_option) -> {
                        val intent = Intent(this, ServiceSummaryActivity::class.java)
                        intent.putExtra("TYPE", "Released Tickets")
                        startActivity(intent)
                        firebaseLogEvent(
