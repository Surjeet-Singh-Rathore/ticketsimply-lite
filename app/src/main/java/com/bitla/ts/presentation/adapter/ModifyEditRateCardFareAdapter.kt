...
class ModifyEditRateCardFareAdapter(
    private val context: Context,
    private var routeWiseFareDetailList: MutableList<RouteWiseFareDetail>,
    private val onItemClickListener: OnItemClickListener,
    private var isFromModifyViewRateCard: Boolean,
    private var onFareChangeParent: ((item: RouteWiseFareDetail) -> Unit),


) :
    RecyclerView.Adapter<ModifyEditRateCardFareAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, @SuppressLint("RecyclerView") position: Int) {
        ...
        val fareDetailsResponse: RouteWiseFareDetail = routeWiseFareDetailList[position]
...
//        holder.rvNestedUpper.setRecycledViewPool(viewPoolUpper)
        ...
        if (!isFromModifyViewRateCard) {
            ...
            val modifyViewRateCardDownAdapter = ModifyViewRateCardDownAdapter(
                context = context,
                fareDetailsList = fareList,
                position,
            ) { item, childPosition ->
            ...
            layoutManagerGrid.initialPrefetchItemCount = fareList.size
            holder.rvNestedDown.layoutManager = layoutManagerGrid
            holder.rvNestedDown.adapter = modifyViewRateCardDownAdapter
        }
