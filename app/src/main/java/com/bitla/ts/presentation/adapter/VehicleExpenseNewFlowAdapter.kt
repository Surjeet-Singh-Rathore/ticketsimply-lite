...
class VehicleExpenseNewFlowAdapter(
    private val context: Context,
    private val vehicleExpenseList: List<VehicleExpense>,
    private val onTextChangedListener: OnTextChangedListener,
) : RecyclerView.Adapter<VehicleExpenseNewFlowAdapter.ViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return vehicleExpenseList.size
    }

    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        val expenses = vehicleExpenseList[position]
    ...
    interface OnTextChangedListener {
        fun onTextChanged(position: Int, expenses: VehicleExpense)
    }
}