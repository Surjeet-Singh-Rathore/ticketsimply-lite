...
import com.bitla.ts.domain.pojo.add_rate_card.createRateCard.request.*
import com.bitla.ts.domain.pojo.add_rate_card.fetchRouteWiseFareDetails.request.*
...
class CreateRateCardActivity : BaseActivity(), DialogButtonListener, DialogSingleButtonListener,
...
//    private val pickUpChartViewModel by viewModel<PickUpChartViewModel<Any?>>()
    ...
    private var routeWiseFareDetails = mutableListOf<FetchRouteWiseFareDetail>()
    ...
    private var amountTypeTime: Int = 1
    private var amountTypeTextTime: String = ""
    // Cmsn
    ...
    private var isRateCardEnable = false
    ...
    private fun getPref() {
        ...
        binding.updateRatecardToolbar.textHeaderTitle.text = getString(R.string.create_rate_card)
        ...
        if (getPrivilegeBase() != null) {
            ...
            isRateCardEnable = privilegeResponseModel?.pinBasedActionPrivileges?.rateCard ?: false
...
//        isCreateRateCard = intent.getBooleanExtra(getString(R.string.create_rate_card), false)
//        Timber.d("isCreateRateCard- $isCreateRateCard")

        callFetchRouteWiseFareDetailsApi(routeId.toString())
    ...
    private fun init() {
        ...
        setTimeData()
        setFetchRouteWiseFareDetailsObserver()
        setCreateRateCardApiObserver()
...
//                    binding.etMinute.filters = arrayOf<InputFilter>(InputFilterMinMax("1", "59"))
    ...
    private fun setCommissionData () {
        ...
        if (configuredAmountType.equals("fixed", true)) {
            binding.apply {
                etAmountCmsn.setText("")
                etAmountCmsn.setText("")
                amountTypeCmsn = 2
                amountTypeTextCmsn = "($currency)"
                layoutAmountCmsn.hint="${getString(R.string.amount)} $amountTypeTextCmsn"
                maxDigitPreventAfterDecimal(binding.etAmountCmsn)
                
                percentageRadioCms.isChecked = false
                fixedRadioCms.isChecked = true
            }
        } else {
            setPercentageRadio()
            binding.apply {
                ...
                amountTypeTextCmsn = "(%)"
                layoutAmountCmsn.hint="${getString(R.string.amount)} $amountTypeTextCmsn"
                etAmountCmsn.setMaxLength(2)
                
                percentageRadioCms.isChecked = true
                fixedRadioCms.isChecked = false
            }
        }
    ...
    private fun setFareAmountTypeNdIncDecOptions() {
        ...
        binding.apply {
            ...
            if (configuredAmountType.equals("percentage", true)) {
                setPercentageRadio()
            } else {
                setFixedRadio()
            }
                        ...
                        btnApply.apply {
                            ...
                            this.setTextColor(
                                ContextCompat.getColor(
                                    this@CreateRateCardActivity, R.color.white
                                )
                            )
                        }
...
//        Timber.d("selectedCityPair_DestinationId- $selectedCityPairDestinationId")
    ...
    private fun cityFromAdapter(fromCityList: MutableList<SpinnerItemsModifyFare>){
        ...
        binding.fromCityET.setAdapter(
            SelectUserTypeModifyFareAdapter(this@CreateRateCardActivity,
                R.layout.spinner_dropdown_item_witch_checkbox,
                R.id.tvItem,
                fromCityList,
...
//        binding.fromCityET.setText("")
    ...
    private fun callCreateRateCardApi(authPin: String) {
        ...
        addRateCardViewModel.createRateCardApi(
            CreateRateCardReqBody(
    ...
    private fun setCreateRateCardApiObserver() {
        addRateCardViewModel.createRateCardResponse.observe(this) {
    ...
    private fun callFetchRouteWiseFareDetailsApi(routeId: String) {

        if (isNetworkAvailable()) {
            addRateCardViewModel.fetchRouteWiseFareDetailsApi(
                FetchRouteWiseFareReqBody(
                    apiKey = loginModelPref.api_key,
                    routeId = routeId,
                    locale = locale ?: ""
                ),
    ...
    private fun setFetchRouteWiseFareDetailsObserver() {

        addRateCardViewModel.fetchRouteWiseFareResponse.observe(this) {
            ...
            if (it != null) {
                when (it.code) {
                    200 -> {
                        fetchRouteWiseFareResponse = it
                        routeWiseFareDetails = it.fetchRouteWiseFareDetails
//                        configuredAmountType = it.configuredAmountType
                        
                        setFareAmountTypeNdIncDecOptions()
                        setCommissionData()
                        
                        addRateCardSingleViewModel.setBranchFetchRouteWiseFareResponse(it)
                        ...
                        layoutManager = GridLayoutManager(this@CreateRateCardActivity, 3)
                        binding.rvSelectSeat.layoutManager = layoutManager
                        multipleHorizontalItemSelectionAdapterFare = MultipleHorizontalItemSelectionAdapter(this@CreateRateCardActivity, this)
                        ...
                        multipleHorizontalItemSelectionAdapter = MultipleHorizontalItemSelectionAdapter(this@CreateRateCardActivity, this)
                        multipleHorizontalItemSelectionAdapter.addData(seatListCmsn)
                    ...
                    411 -> {
                        if (it.message != null) {
                            it.message.let { it1 -> this@CreateRateCardActivity.toast(it1) }
                        }
                    }
                    401 -> {
                        ...
                        if (it.result?.message != null) {
                            it.result.message.let { it1 -> this@CreateRateCardActivity.toast(it1) }
                        }
                    }
                }
            } else {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (resultCode == SELECT_SERVICE_INTENT_REQUEST_CODE) {
            ...
            addRateCardSingleViewModel.branchFetchRouteWiseFareLiveData.value?.fetchRouteWiseFareDetails?.forEach {
                val cityWiseFare =
                    CityWiseFare(
                        originId = it.originId,
                        destinationId = it.destinationId,
    ...
    private fun setIntent() {
        val intent = Intent(this, ModifyCreateRateCardActivity::class.java)
        ...
        intent.apply {
            ...
            putExtra(
                ...
                jsonToString(fetchRouteWiseFareResponse ?: "")
            )
            putExtra(
            ...
            modifyFareBT.setOnClickListener {
                ...
                if (selectedFromCityList.size >= 1 && selectedToCityList.size >= 1) {
                    if (selectedFromCityList[0].value == selectedToCityList[0].value
                        ...
                        toast(this@CreateRateCardActivity.getString(R.string.city_pair_not_found))
                    } else {
                        setIntent()
                    }
                } else {
...
//                Timber.d("fareSeatIdList - $seatId")
            ...
            btnSaveModifyService.setOnClickListener {
                ...
                showProgressDialog(this@CreateRateCardActivity)
                ...
                if (isNetworkAvailable()) {
                    if (isRateCardEnable && country.equals("india", true)) {
                        DialogUtils.showFullHeightPinInputBottomSheet(
                            activity = this@CreateRateCardActivity,
                            fragmentManager = supportFragmentManager,
                            pinSize = pinSize,
                            getString(R.string.rate_card),
                            onPinSubmitted = { pin: String ->
                                callCreateRateCardApi(pin)
                                dismissProgressDialog()
                            },
                            onDismiss = {
                                dismissProgressDialog()
    ...
    private fun incrementAndDecrementFare(cityWiseFareList: MutableList<CityWiseFare>) {
        ...
        var fareDetailsList = mutableListOf<FetchRouteWiseFareDetail>()
        ...
        if(addRateCardSingleViewModel.branchFetchRouteWiseFareLiveData.value!!.fetchRouteWiseFareDetails.isNotEmpty()){
            fareDetailsList = addRateCardSingleViewModel.branchFetchRouteWiseFareLiveData.value!!.fetchRouteWiseFareDetails
        }
...
//        cityWiseFareList.clear()
//
//        fetchRouteWiseFareResponse?.fetchRouteWiseFareDetails?.forEach { outerLoop ->
...
//    }
    ...
    private fun openFromDateDialog() {
        ...
        setDateLocale(locale!!, this@CreateRateCardActivity)
        val dpDialog = DatePickerDialog(this@CreateRateCardActivity, listener, year, month, day)
...
//            dpDialog.datePicker.maxDate = calendar.timeInMillis
    ...
    override fun onSingleButtonClick(str: String) {
        if (str == getString(R.string.unauthorized)) {
            //clearAndSave(this@CreateRateCardActivity)
    ...
    private fun refreshPage() {
        ...
        binding.apply {
            ...
            amountType = 1
            incOrDec = 0
            tvIncPercentage.text = "${getString(R.string.increase)} (%)"
            layoutAddpercentage.hint = "${getString(R.string.add_lowercase)} (%)"
