...
class CrewDetailsFragment : BaseFragment(), View.OnClickListener, DialogSingleButtonListener,
    OnItemCheckMultipleItemListener {
    ...
    override fun onCreateView(
        ...
        binding = FragmentCrewDetailsBinding.inflate(inflater, container, false)
...
//            val privilegeResponseModel = (activity as BaseActivity).getPrivilegeBase() as PrivilegeResponseModel
//        }
        ...
        pickUpChartViewModel.privilegesLiveData.observe(requireActivity()) { privilegeResponseModel ->
            ...
            privilegeResponseModel?.apply {
                ...
                this@CrewDetailsFragment.country = country
                ...
                if (isFromChile){
                    binding.layoutDriver3.visible()
                } else{
                    binding.layoutDriver3.gone()
                }
    ...
    private fun clickListener() {
        ...
        binding.apply {
            ...
            acSelectCoach.setOnClickListener {
                val intent = Intent(requireContext(), CrewAllListSelectedActivity::class.java)
                intent.putExtra(getString(R.string.res_id), resID)
                intent.putExtra(getString(R.string.crewDetailsKey), getString(R.string.coach))
                intent.putExtra(
                    "isValidateBusCrewUpdationForCoachs",
                    isValidateBusCrewUpdationForCoachs
                )
                resultLauncher.launch(intent)
            }
            spinnerSelectCoach.setEndIconOnClickListener {
            ...
            layoutDriver1.setEndIconOnClickListener {
                ...
                val intent = Intent(requireContext(), CrewAllListSelectedActivity::class.java)
                intent.putExtra(getString(R.string.res_id), resID)
                intent.putExtra(getString(R.string.crewDetailsKey), getString(R.string.driver_1))
                intent.putExtra(
                    "isValidateBusCrewUpdationForCoachs",
                    isValidateBusCrewUpdationForCoachs
                )

                val temp = arrayListOf<Employee>()
                driver1List.forEach {
                    temp.add(it)
                }

                val bundle = Bundle()
                bundle.putSerializable("employeeArrayList", temp as Serializable)
            ...
            layoutDriver2.setEndIconOnClickListener {
                ...
                val intent = Intent(requireContext(), CrewAllListSelectedActivity::class.java)
                intent.putExtra(getString(R.string.res_id), resID)
                intent.putExtra(getString(R.string.crewDetailsKey), getString(R.string.driver_2))
                intent.putExtra(
                    "isValidateBusCrewUpdationForCoachs",
                    isValidateBusCrewUpdationForCoachs
                )
            ...
            layoutDriver3.setEndIconOnClickListener {
                ...
                if(binding.acSelectCoach.text.toString().isEmpty() && isValidateBusCrewUpdationForCoachs == true){
                    requireContext().toast(getString(R.string.pleaseSelectCoach))
                    return@setEndIconOnClickListener
                }
                val intent = Intent(requireContext(), CrewAllListSelectedActivity::class.java)
                intent.putExtra(getString(R.string.res_id), resID)
                intent.putExtra(getString(R.string.crewDetailsKey), getString(R.string.driver_3))
                intent.putExtra("isValidateBusCrewUpdationForCoachs", isValidateBusCrewUpdationForCoachs)
            ...
            layoutCleaner.setEndIconOnClickListener {
                ...
                val intent = Intent(requireContext(), CrewAllListSelectedActivity::class.java)
                intent.putExtra(getString(R.string.res_id), resID)
                intent.putExtra(getString(R.string.crewDetailsKey), getString(R.string.cleaner2))
                intent.putExtra(
                    "isValidateBusCrewUpdationForCoachs",
                    isValidateBusCrewUpdationForCoachs
                )
            ...
            layoutContractor.setEndIconOnClickListener {
                ...
                if (country != null && country.equals(INDIA, true)) {
                    intent.putExtra(getString(R.string.crewDetailsKey), getString(R.string.conductor2))
                } else {
                    intent.putExtra(getString(R.string.crewDetailsKey), getString(R.string.contractor2))
                }
                intent.putExtra(
                    "isValidateBusCrewUpdationForCoachs",
                    isValidateBusCrewUpdationForCoachs
...
//            acDriver1.setOnItemClickListener { parent, view, position, id ->
//                driver2List.removeAt(position)
//                selectedDriver1Id = driver1List[position].id.toString()
//            }

//            acDriver2.setOnItemClickListener { parent, view, position, id ->
//                driver1List.removeAt(position)
//                selectedDriver2Id = driver2List[position].id.toString()
//
//            }

//            acCleaner.setOnItemClickListener { parent, view, position, id ->
//                selectedCleanerId = cleanerList[position].id.toString()
//            }

//            acCheckingInspector.setOnItemClickListener { parent, view, position, id ->
//                selectedCheckInspectorId = checkingInspectorList[position].id.toString()
//            }

//            acSelectCoach.setOnItemClickListener { parent, view, position, id ->
//                selectedCoachId = coachList[position].id.toString()
//            }

//            acContractor.setOnItemClickListener { parent, view, position, id ->
//                selectedContracterId = contractorList[position].id.toString()
//            }
    ...
    override fun onClick(v: View?) {
        ...
        when (v?.id) {
            ...
            R.id.cross_coach -> {
                ...
                binding.autoFillDetailsCheckboxLayout.gone()
                        ...
                        200 -> {
                            ...
                            if(isAllowToAutoFillCrewDetails == true) {
                                ...
                                if(selectedCoachId.isNotEmpty()) {
                                    binding.autoFillDetailsCheckboxLayout.visible()
                                }
...
//        callEmployeesDetailsApi()
    ...
    private fun coachCross() {
        if (binding.acSelectCoach.text.isNotBlank()) {
    ...
    private fun setAllCoachObserver() {
        ...
        pickUpChartViewModel.allCoachResponse.observe(requireActivity()) { it ->
            try {
                ...
                if (it != null) {
                    if (it.code == 200) {
                        it.allCoaches.reversed().forEach {
