...
class NewRevenueChannelFragment : BaseFragment(), com.bitla.ts.data.listener.OnItemClickListener {
    ...
    override fun onCreateView(
        ...
        binding.allServicesAndDateFilterContainer.tvAllService.gone()
        binding.allServicesAndDateFilterContainer.tvDate.setLayoutParams(
