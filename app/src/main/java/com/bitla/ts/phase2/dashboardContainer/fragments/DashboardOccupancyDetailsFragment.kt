...
import com.bitla.ts.databinding.FragmentDashboardOccupancyDetailsBinding
...
class DashboardOccupancyDetailsFragment : BaseFragment() {

    private lateinit var binding: FragmentDashboardOccupancyDetailsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentDashboardOccupancyDetailsBinding.inflate(inflater, container, false)
    ...
    private fun initTab() {
        val tabDayWise = Tabs()
        tabDayWise.title = getString(R.string.day_wise)
        ...
        val fragmentAdapter = DashboardOccupancyDetailsPagerAdapter(
            requireContext(),
            tabsList,
